...
// A continuación se presentará un algoritmo donde:
// n disminuirá o aumentará a la unidad según se presione "boton1" o "boton2".
// n es una función identidad de (lo mismo que) "cantidad".
// n multiplicará a la constante "precio"
// "Total a pagar" es una función afín y variable dependiente de n.
...
boton2.addEventListener("click", () => {
    ...
    if (n <= 0) {
        ...
        tarjeta = document.querySelector(".card")
        tarjeta.style.backgroundColor = "#7ba238"
    }
